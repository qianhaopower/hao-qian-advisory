...
- **Ep. 19 "Muscle Memory in the Age of AI"** (spoken without a script; the RESTYLE episode: built in CapCut via `scripts/video-pipeline/to_capcut_wt.py` with the 小红书 look — warm grade, title on frame 1, gold punch words, bordered captions, self-made top-down sim inserts from `make_sim_wt.py`, CTA end card, CC-BY piano bed): filmed 2026-09-25, 97s; shelf copy = the posted H.264 file as-is; poster = the baked frame-1 cover; VTT from the CapCut caption chunks; canonical `/videos/muscle-memory-in-the-age-of-ai`. Music: Kevin MacLeod (incompetech.com), CC-BY, credited in the post. Posted to LinkedIn 2026-09-25.
