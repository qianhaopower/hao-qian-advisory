...
export const EPISODES: VideoEpisode[] = [
  ...
  {
    slug: "fi-six-countries",
    series: "friends-intelligence",
    sequence: 14,
    title: "脂肪被冤了五十年,就因为这六个点",
    titleEn: "Six points that framed fat",
    status: "published",
    publishedAt: "2026-09-24",
    language: "zh-Hans",
    durationSeconds: 409,
    topic: "营养智慧 · Nutrition Intelligence",
    hook: "1953 年一张只画了六个国家的图,把脂肪钉在了心脏病元凶的位置上——而当时能拿到的数据有 22 个国家。",
    summary:
      "一段真实的营养学史。Ancel Keys 1953 年发表六国图:脂肪吃得越多,心脏病越多,一条完美的线。1957 年两位统计学家把当时能拿到的 22 个国家全放上去,关系弱得多——他只挑了正好排成一条线的六个。2016 年 JAMA Internal Medicine 公开的行业文件又补了一刀:糖业研究基金会付钱给哈佛学者,1967 年在《新英格兰医学杂志》发综述,淡化糖、把矛头指向脂肪。半个世纪,脂肪背了锅。落到自己的生活:看配料表,糖有上百个名字;能吃新鲜的,就别吃加工的。片中几处口误已在字幕与文字稿中更正。",
    videoUrl:
      "https://github.com/qianhaopower/hao-qian-advisory/releases/download/media/fi-six-countries.mp4",
    aspect: "9:16",
    poster: "/videos/fi-six-countries/poster.jpg",
    captions: "/videos/fi-six-countries/captions.vtt",
    transcript: [
      "今天我们再跟大家分享一个历史上真实发生过的故事,这个故事可能和你餐桌上的几乎每一个食品都相关,甚至和你家里买的每一个带包装的食品的成分都相关,这就是在历史上195 几年的时候应该是55年的时候〔更正:1953 年〕,美国兴起了一个研究心脏病发病原因的一波浪潮,就是很多很多的科学机构还有研究机构都在找到底人们为什么会得心脏病冠心病一类的疾病。",
      "这里边呢就有一个人,他叫 Ancel Keys,这个人的名字可以记住真的不是什么好人,他就做了一项非常臭名昭著的六国研究,他这项研究是怎么做的呢,就是他发布了一份报告,把这六个国家平均成年人摄入脂肪含量和得心脏病冠心病的这个概率的关系,做了一个曲线,得出的这六个国家的曲线非常漂亮,就是说摄入脂肪越少的国家,他得冠心病和心脏病的几率就非常的低,比如说日本就在最下面,然后稍微高一点的话,比如说威尔士,新西兰〔更正:六国中没有新西兰〕澳大利亚就会稍微高一点,脂肪摄入多,心脏病的概率增加,然后最高的就是美国,脂肪摄入非常高,心脏病的概率也非常高,几乎这六个国家是一条完美的曲线,这个事情发表了以后正好赶上了1955年应该是美国的艾森豪威尔去世,心脏病去世〔更正:1955 年心脏病发作,并未去世;1969 年逝世〕,所以说当时在国内也掀起了轩然大波,就促进了当时公众对心脏病发病原因的一波关注,那他这个报告几乎就马上变成了一个官方认可的报告,从此以后脂肪就被打上了,会造成心脏病的一个,脂肪是心脏病元凶这样一个标签,但是过了一段时间以后呢。",
      "人们就开始研究说,他当时这个报告很有问题,为什么呢,因为这条六个国家的这个曲线实在是太完美了,就是统计学上都很难出现像这种直线一样的这种统计曲线,那么人们就把它当时做的原始的这些数据比较拿出来看了一下,发现他当时做的比较的话有22个国家,这22个国家的话,这个曲线基本上是一个随机分布的散点图,发现他们有的国家脂肪含量,脂肪这个摄入量非常高,但是他的心脏病的概率并不高,有的国家脂肪摄入量非常低,但是他得心脏病的概率也很低,所以说就是基本上是一个散点图,那么这六个国家是怎么回事呢,就是这个 Ancel Keys 这个人,他自己选了这个一堆图中的六个几乎成直线的一个点,就是把这六个国家从这22个图中拿出来,然后说这就是这条曲线,然后发表的结果,可以说非常恶心对吧,就是经典的用事实说谎,用真实的数据来说谎,所以说后面还有很多制糖业的这些公司的推波助澜,应该是在2016年前后的话。",
      "通过对历史文档的调查,人们发现当时美国的制糖业实际上是大约赞助了6500万美元〔更正:6,500 美元,约合今天 5 万美元;付给三位哈佛学者〕,在当时195 几年、196 几年的时候,这是一个巨大的数字,赞助了哈佛还有很多当时的高校,去研究什么东西导致了心脏病,那研究出来的结果没有意外,大部分都不是糖对吧,但是现在这么多年以后过去,人们逐渐开始意识到游离糖。",
      "或者就是糖本身实际上是对我们身体的损害,要远大于脂肪,比如说现在我们有很多个共识,就是说胆固醇过去三五十年,我们一直说它是非常不好的东西,对吧,鸡蛋一天要吃一个不能多吃,动物脂肪我们不能超过多少克,但是现在最新研究的表明,你体内的胆固醇的含量,其实很大一部分程度都是由基因造成的,并不是由于你摄入多少脂肪,因为你能摄入的胆固醇的量是一定的,很大程度上就是受到了当年这个制糖业推动的,心脏病元凶的调查的这样一波,不可靠的调查吧,所以讲这个故事就是说我们过去五十年很长一段时间,我们都错怪了脂肪。",
      "其实脂肪它本身并不像在过去五十年中,人们一直想的害处那么的大,糖我们一直觉得它好像危害没有那么大,其实糖的危害是非常非常大的,对我们的衰老对我们的记忆,对我们的情绪对我们的认知,可以说是伤害要比脂肪大的大的多,但是就因为当年有这种历史上的坏人,可以这么说,在更坏的人的推动之下,让历史的发展走了一个弯路,人们整个世界甚至是西方国家吧,花了可能半个世纪,才逐渐把这种misconception,这种错误的认知,逐渐逐渐扭转过来,那对于我们自己生活呢,就是吃饭之前看看包装。",
      "凡是包装上边有糖,sugar、maple syrup、reconstituted syrup,就是有各种各样跟糖差不多相关的这些东西,我到时候会单拍一期讲,这有上百种你就不要碰它,尽量不要碰,当然最好的办法就是说吃新鲜的东西,对吧,你买蔬菜水果里面是不含糖的,就算含糖它是天然的,以一种没有被破坏的方式产生的糖,那也要比你吃这些processed,food要强的多。",
    ],
    keyPoints: [
      "六个点能画出一条完美的线;二十二个点就是一片散点。选数据,就是用真实的数据说谎。",
      "糖业付了钱,脂肪背了锅——半个世纪才扭转。",
      "配料表上的糖有上百个名字;新鲜的永远比加工的强。",
    ],
    platformCaption:
