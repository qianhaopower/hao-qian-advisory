...
export const metadata: Metadata = {
  title: "Leadership Advisory (archived)",
  description:
    "Hao Qian's 1:1 advisory practice for first-time and early-stage tech managers. Archived; enquiries still welcome.",
  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto max-w-3xl px-5 py-12 md:py-16">
        {/* Archive note */}
        <div className="mb-8 rounded-xl border border-slate-200 bg-slate-50 px-5 py-4 text-sm leading-relaxed text-slate-600">
          <span className="font-semibold text-slate-800">From the archive.</span>{" "}
          This was the front page of haoqian.co in 2026, when the site led with
          a 1:1 advisory practice. The site is now{" "}
          <Link href="/" className="underline underline-offset-4 hover:text-slate-900">
            a library
          </Link>
          — but the practice is kept intact here, and enquiries still reach me.
        </div>
